...
:::theorem "one_field_multiplicative_reconstruction" (parent := "integral_mono_anabelian") (lean := "Anabelian.LCFT.LocalReciprocityMap.injective, Anabelian.LCFT.mem_baseIntegerMonoid_iff_exists_uniformizer_pow_mul_integerUnit, Anabelian.LCFT.unramifiedProjection, Anabelian.LCFT.intrinsicBaseIntegerMonoid, Anabelian.LCFT.LocalReciprocityFamily.intrinsicIntegerMonoidHom, Anabelian.LCFT.LocalReciprocityFamily.intrinsicIntegerMonoidHom_surjective, Anabelian.LCFT.LocalReciprocityFamily.baseIntegerMonoidEquiv")
%%%
source := {
  document := "hoshi"
  spans := #[{
